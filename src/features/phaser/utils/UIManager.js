...
export default class UIManager {
  ...
  updateXPBar() {
    ...
    const fillWidth = barWidth * (this.scene.character.xp / this.scene.character.xpToNextLevel);
  ...
  updateHealthBar() {
    ...
    const healthWidth = width * (this.scene.character.health / this.scene.character.maxHealth);
