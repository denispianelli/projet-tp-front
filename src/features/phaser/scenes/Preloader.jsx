 ...
 * Pendant le chargement, une barre de progression est affichée pour indiquer
 * le progrès du chargement.
 */
export default class Preloader extends Scene {
  ...
  init() {
    ...
    // Écoute l'événement 'progress' émis par le chargeur de ressources pour
   ...
   * Charge les ressources nécessaires au jeu, comme les images, les sons, les
   * données de carte, etc.
   */
  preload() {
