 ...
 * Permet au joueur de naviguer dans le menu principal, de régler les
 * paramètres audio et de démarrer une nouvelle partie.
 */
export default class MainMenu extends Scene {
   ...
   * Initialise les touches de curseur, récupère les données transmises par la
   * scène précédente et charge les données des personnages.
